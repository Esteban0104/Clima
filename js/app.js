...
function cambiarIcoPais (){
  const pais = document.querySelector('#pais').value;
  document.getElementById('img').src=`./img/${pais}.png`; 
}
/*  switch(pais){
      case 'CO':
        document.getElementById('img').src='./img/colombia.png';
        break;
      case 'MX':
        document.getElementById('img').src='./img/mexico.png';
        break;
      case 'ES':
        document.getElementById('img').src='./img/espana.png';
        break;
      case 'AR':
        document.getElementById('img').src='./img/argentina.png';
        break;
      case 'PE':
        document.getElementById('img').src='./img/peru.png';
        break;
  }
 */
...
function mostrarClima(datos) {
  ...
  nombreCiudad.classList.add('font-bold', 'text-1xl')

  const actual = document.createElement('p');
  actual.innerHTML = `${grados} &#8451;`;
  actual.classList.add('font-bold', 'text-1xl')
